...
function BarChart({
  ...
  return (
    <div className="bg-textnavbar m-fit p-4 rounded shadow-md text-black">
      <Bar data={data} />
    </div>
  );
}
...
function DoughnutChart({
  ...
  return (
    <div className="bg-textnavbar p-4 rounded shadow-md text-black">
      <Doughnut data={data} />
    </div>
  );
}
  ...
  return (
    <div className="bg-gray-100 p-6 rounded-lg shadow-lg">
      <h2 className="text-2xl font-semibold mb-4">
        Histórico de Utilização de Aplicações
      </h2>
      ...
      <div className="flex flex-wrap space-y-4 md:space-y-0 md:space-x-4 mt-4">
        <BarChart data={barChartData} />
        <DoughnutChart data={doughnutChartData} />
        <LineChart data={lineChartData} />
      </div>

      <div className="bg-textnavbar mt-4 p-4 rounded-lg shadow-lg text-white">
        <h3 className="text-lg font-semibold">Diferença de Semanas</h3>
        <div className="mt-4">
          <LineChart2 data={combinedBarChartData} />
        </div>
      </div>
    </div>
  );
